...
class CursorFollower {
    ...
    init() {
        ...
        document.querySelectorAll('a, button, .btn, .project-card, .nav-link').forEach(el => {
...
class LoadingAnimation {
    ...
    init() {
        ...
        // Ajouter un loader initial si ce n'est pas déjà fait
    ...
    addLoader() {
        // Vérifier si la page vient d'être chargée
        ...
        loader.innerHTML = `
            <div style="text-align: center;">
                <div style="font-size: 2rem; font-weight: 700; margin-bottom: 1rem; color: var(--text-main);">
                    ROGATIANA<span style="color: var(--primary);">.</span>
                </div>
                <div style="width: 200px; height: 3px; background: var(--bg-inset); border-radius: 3px; overflow: hidden;">
                    <div class="loader-bar" style="width: 0%; height: 100%; background: linear-gradient(90deg, var(--primary), var(--secondary)); transition: width 0.8s;"></div>
                </div>
            </div>
        `;
...
class EnhancedAnimations {
    ...
    init() {
        ...
        try { new ParallaxSimple(); } catch (e) { console.warn('Parallax non chargé', e); }
        try { new CounterAnimation(); } catch (e) { console.warn('Counter non chargé', e); }
        try { new TypingEffect(); } catch (e) { console.warn('Typing non chargé', e); }
        try { new RippleEffect(); } catch (e) { console.warn('Ripple non chargé', e); }
        try { new LoadingAnimation(); } catch (e) { console.warn('Loading non chargé', e); }
    }
}
